...
class CocoDet(openpifpaf.datasets.DataModule):
    # cli configurable
    train_annotations = 'data-mscoco/annotations/detection_class_agnostic_instances_train2017.json'
    val_annotations = 'data-mscoco/annotations/detection_class_agnostic_instances_val2017.json'
