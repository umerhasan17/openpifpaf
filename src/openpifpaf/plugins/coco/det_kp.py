...
class CocoDetKpTriplets(openpifpaf.datasets.DataModule, openpifpaf.Configurable):
    ...
    # cli configurable
    train_annotations = 'data-mscoco/annotations/detection_class_agnostic_detection_cornernet_instances_train2017.json'
    val_annotations = 'data-mscoco/annotations/detection_class_agnostic_detection_cornernet_instances_train2017.json'
